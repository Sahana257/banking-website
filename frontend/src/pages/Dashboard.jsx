...
export default function Dashboard() {
  ...
  useEffect(() => {
    axios.post('https://bank-backend-yoie.onrender.com/api/getBalance', {}, { withCredentials: true })
  ...
  const handleCheckBalance = async () => {
    ...
    setConfetti(false)
    try {
      const res = await axios.post('https://bank-backend-yoie.onrender.com/api/getBalance', {}, { withCredentials: true })
